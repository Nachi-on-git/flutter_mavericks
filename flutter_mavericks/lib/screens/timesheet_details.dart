...
class _TimesheetDetailsState extends State<TimesheetDetails> {
  ...
  int getDaysInMonths() {
    ...
    DateTime endDate = DateTime(currentDate.year, currentDate.month, totalDaysInMonths);
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      Container(
          ...
          decoration: BoxDecoration(border: Border.all(color: ColorSystem.gray.withOpacity(0.6)), borderRadius: BorderRadius.circular(15)),
          child: Column(children: [
            Container(
                padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 20),
                decoration: const BoxDecoration(
                    color: ColorSystem.primaryColor, borderRadius: BorderRadius.only(topLeft: Radius.circular(10), topRight: Radius.circular(10))),
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        const Text(
                          'Emp ID',
                          style: TextStyle(color: ColorSystem.gray, fontSize: SizeSystem.size20),
                        ),
                      ],
                    ),
                    const SizedBox(
                    ...
                    const Text(
                      ...
                      style: TextStyle(fontWeight: FontWeight.bold, color: ColorSystem.white, fontSize: SizeSystem.size30),
                    )
                  ],
                )),
            Container(
                ...
                child: Column(children: [
                  ...
                  Row(
                    children: [
                      RichText(
                        ...
                        WidgetSpan(child: Text('Hrs', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold))),
                      ]))
                    ],
                  ),
                  const SizedBox(
                    ...
                    Row(
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(color: ColorSystem.primaryColor, borderRadius: BorderRadius.circular(10)),
                        ),
                        const SizedBox(
                          width: 15,
                        ),
                        Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Text(
                            'Billable',
                            style: TextStyle(color: ColorSystem.gray.withOpacity(0.6), fontSize: 15),
                          ),
                          const Text(
                            '150 Hrs',
                    ...
                    Row(
                      ...
                      children: [
                        Container(
                          ...
                          width: 40,
                          margin: const EdgeInsets.only(top: 8),
                          decoration: BoxDecoration(color: ColorSystem.gray.withOpacity(0.4), borderRadius: BorderRadius.circular(10)),
                        ),
                        const SizedBox(
                          width: 15,
                        ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      const Text('2', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 30)),
                    ],
                  ),
                  Row(
                    crossAxisAlignment: CrossAxisAlignment.end,
